...
class _AnnouncementsScreenState extends State<AnnouncementsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: hr.isLoading && hr.announcements.isEmpty
          ? const Center(child: CircularProgressIndicator())
          : hr.announcements.isEmpty
              ? Center(
                  child: Column(
                    ...
                    children: const [
                      ...
                      SizedBox(height: 12),
                      Text('No active announcements.', style: TextStyle(color: Color(0xFF64748B), fontSize: 15)),
                    ],
                  ),
                )
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: hr.announcements.length,
                    itemBuilder: (context, index) {
                      final anc = hr.announcements[index];
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Icon(_titleIcon(anc.title), color: audienceColor, size: 20),
                                      ),
